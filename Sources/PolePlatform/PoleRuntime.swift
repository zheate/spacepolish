...
@MainActor
private final class PoleAppDelegate: NSObject, NSApplicationDelegate {
...
package func runPoleApplication() {
    ...
    let delegate = MainActor.assumeIsolated { PoleAppDelegate() }
