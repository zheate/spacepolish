...
enum ApplicationWritingRole: String, Equatable {
    ...
    var modelInstruction: String? {
        ...
        case .messaging:
            return """
            当前内容是即时聊天消息。优先保留原文的说话方式、亲疏程度、自然省略和分句节奏，只调整确实影响理解或流畅度的部分。使用日常口语和短句，像本人直接发出的消息；礼貌不等于正式。不要改成邮件、通知、工作汇报、会议纪要或客服话术，不要为了显得完整而补主语、铺背景、加称呼、客套话、总结或下一步，也不要把一句短消息扩写成一段。
            """
        case .generic:
            return nil
        }
